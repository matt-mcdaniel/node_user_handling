...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userList = __webpack_require__(238);

	var _userList2 = _interopRequireDefault(_userList);

	var _userDetail = __webpack_require__(242);
	...
	socket.on('readme', function (data) {
		_logger2.default.dispatch({ 'type': 'README', 'readme': data });
	});
	...
	socket.on('users', function (data) {
		...
		data.forEach(function (u) {
			return _logger2.default.dispatch({ 'type': 'ADD_USER', 'user': u });
		});
		render();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabList = __webpack_require__(235);
	...
	var App = _react2.default.createClass({
		...
		getInitialState: function getInitialState() {
			...
			var locations = _tabList2.default.map(function (tab) {
				return tab.url;
			});
	...
	var Tab = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_reactRouter.Link,
					{ to: this.props.url, onClick: this.handleClick },
					this.props.name
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userListItem = __webpack_require__(241);
	...
	*/
	...
	var Users = _react2.default.createClass({
		...
		handleNewState: function handleNewState() {
			// Set the new state
			this.setState({
				users: this.context.store.getState().users
			});
		...
		handleUserSelect: function handleUserSelect(user) {
		...
		render: function render() {
			if (this.state.users) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'ul',
						{ className: 'media-list col-xs-12' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserListItem = _react2.default.createClass({
		...
		formatCompany: function formatCompany(str) {
			return str.toLowerCase().replace(/\b\w/g, function (m) {
				return m.toUpperCase();
			});
		},
		formatDate: function formatDate(str) {
			return str.slice(0, 10).split('-').move(0, 2).join('-');
		},
		formatTags: function formatTags(arr) {
			return arr.slice(0, 2).map(function (tag) {
				return _react2.default.createElement(
					'p',
					{ className: 'tags label label-default', key: tag },
					' ',
					tag,
					' '
				);
		...
		render: function render() {
			...
			var registered = this.formatDate(user.registered);
			var company = this.formatCompany(user.company);
			var tags = this.formatTags(user.tags);
			return _react2.default.createElement(
				'li',
				{ className: 'media col-xs-12', key: user._id, onClick: this.handleUserSelect.bind(this, user) },
				_react2.default.createElement(
					_reactRouter.Link,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'ul',
							{ className: 'user-properties-list' },
							_react2.default.createElement(
								'li',
								null,
								_react2.default.createElement(
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'tbody',
					{ onClick: this.edit },
					Object.keys(user).filter(function (v) {
						...
						return _react2.default.createElement(
							'tr',
							{ key: i, className: active ? 'table-row active' : 'table-row' },
							_react2.default.createElement(
								'th',
								{ className: 'table-header' },
								key
							...
							_react2.default.createElement(
								'td',
								{ className: active ? 'view hidden' : 'view', id: 'view_' + key },
								val
							),
							_react2.default.createElement(
								'td',
								{ className: active ? 'edit active' : 'edit', id: 'edit_' + key },
								_react2.default.createElement('input', { className: 'form-control', onChange: this.handleChange, type: 'text', value: this.state.value })
							)
						);
					}, this)
				)
		...
		render: function render() {
			if (this.state.readme) {
				return _react2.default.createElement(
					'div',
					{ className: 'col-xs-12' },
					_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: this.state.readme } })
				);
			}
			return _react2.default.createElement(
				'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer = function reducer() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { readme: null, users: [] } : arguments[0];
		...
		if (action.type === 'README') {
			...
			state.users = [].concat(_toConsumableArray(state.users), [action.user]);
			return state;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var middleware = (0, _redux.applyMiddleware)(logger)(_redux.createStore);
	var store = middleware(_reducer2.default);
